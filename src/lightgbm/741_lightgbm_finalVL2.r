...
kprefijo       <- "KA741VL2"
ksemilla_azar  <- 677119  #Aqui poner la propia semilla
kdataset       <- "./datasets/paquete_premium_ext_721VL2.csv.gz"
...
kmax_bin           <-    31
klearning_rate     <-     0.010126023
knum_iterations    <-   1104
knum_leaves        <-  356
kmin_data_in_leaf  <- 19996
kfeature_fraction  <-     0.769317058
