...
kdataset       <- "./datasets/paquete_premium_ext_722V2.csv.gz"
...
kmax_bin           <-    31
klearning_rate     <-     0.0100194052868624
knum_iterations    <-   1412
knum_leaves        <-  1926
kmin_data_in_leaf  <- 17807
kfeature_fraction  <-     0.823806001812445
